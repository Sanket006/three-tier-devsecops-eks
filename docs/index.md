...
| [09 — Architecture Diagrams](./09-architecture-diagrams.md) | Detailed AWS, CI/CD, and Kubernetes diagrams |
...
1. Read the **[Project Overview](./01-project-overview.md)** and review the **[Architecture Diagrams](./09-architecture-diagrams.md)** to understand the environment.
